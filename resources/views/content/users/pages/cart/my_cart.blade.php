                ...
                <div class="row">
                    ...
                    <div class="col-12">
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-des product-name">
                                                <h5 class="product-name"><a
                                                        href="{{url('product_details',$cart->id)}}">{{ $cart->product }}</a></h5>
                        ...
                        <div class="cart-action text-end">
                            <a href="{{ url('show_order') }}" class="btn "><i
                                    class="fi-rs-shopping-bag mr-10"></i>My Order</a>
                        ...
                        <div class="row mb-50">
                            ...
                            <div class="col-md-6">
                                ...
                                <form method="post">
                                    <div class="form-group">
                                        <input type="text" required="" name="fname" value="{{$user->name}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="billing_address" required="" value="{{$user->address}}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="ship_detail">
                                        ...
                                        <div id="collapseAddress" class="different_address collapse in">
                                            <div class="form-group">
                                                <label for="">Select Your Zilla </label>
                                            ...
                                            <div class="form-group">
                                                <input required="" type="text" name="state" placeholder="Loation *">
                                            </div>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="border p-md-4 p-30 border-radius cart-totals">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"><span
                                                            class="font-lg fw-900 text-brand">${{ $totalprice }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    {{-- <a href="{{ url('cash_order') }}" class="btn "> <i
                                            class="fi-rs-box-alt mr-10"></i>Case on Delivery</a>
                                    <a href="checkout.html" class="btn "> <i class="fi-rs-box-alt mr-10"></i> Proceed To
                                        ...
                                        <a href="{{url('cash_order')}}" class="btn btn-fill-out btn-block mt-30">Place Order</a>
                                    </div>
                                </div>
                            </div>
                        </div>
