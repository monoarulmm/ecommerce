  ...
  <section class="mt-50 mb-50">
      <div class="container">
          <div class="row">
              ...
              <div class="col-12">
                <form action="{{url('update_product_confirm',$cart->id)}}" method="POST">@csrf
                ...
                <div class="cart-action text-end">
                    ...
                    <a href="javascript:$('form').submit();" class="btn  mr-10 mb-sm-15"><i class="fi-rs-shuffle mr-10"></i>Update Cart</a>

                    <a href="{{url('user/product')}}" class="btn "><i class="fi-rs-shopping-bag mr-10"></i>Continue Shopping</a>
                </div>
